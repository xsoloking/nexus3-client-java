...
public class BlobStoreApi {
    ...
    /**
     * Build call for createBlobStore1
     * @param body  (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call createBlobStore1Call(AzureBlobStoreApiModel body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;

        // create path and map variables
        String localVarPath = "/v1/blobstores/azure";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call createBlobStore1ValidateBeforeCall(AzureBlobStoreApiModel body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = createBlobStore1Call(body, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void createBlobStore1(AzureBlobStoreApiModel body) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> createBlobStore1WithHttpInfo(AzureBlobStoreApiModel body) throws ApiException {
        com.squareup.okhttp.Call call = createBlobStore1ValidateBeforeCall(body, null, null);
        return apiClient.execute(call);
    }

    /**
     * Create an Azure blob store (asynchronously)
     * 
     * @param body  (optional)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call createBlobStore1Async(AzureBlobStoreApiModel body, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createBlobStore1ValidateBeforeCall(body, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public S3BlobStoreApiModel getBlobStore(String name) throws ApiException {
        ApiResponse<S3BlobStoreApiModel> resp = getBlobStoreWithHttpInfo(name);
        return resp.getData();
    }
     ...
     * 
     * @param name Name of the blob store configuration to fetch (required)
     * @return ApiResponse&lt;S3BlobStoreApiModel&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<S3BlobStoreApiModel> getBlobStoreWithHttpInfo(String name) throws ApiException {
        com.squareup.okhttp.Call call = getBlobStoreValidateBeforeCall(name, null, null);
        Type localVarReturnType = new TypeToken<S3BlobStoreApiModel>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Get a S3 blob store configuration by name (asynchronously)
     * 
     * @param name Name of the blob store configuration to fetch (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getBlobStoreAsync(String name, final ApiCallback<S3BlobStoreApiModel> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getBlobStore1Call(String name, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/v1/blobstores/azure/{name}"
            .replaceAll("\\{" + "name" + "\\}", apiClient.escapeString(name.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getBlobStore1ValidateBeforeCall(String name, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'name' is set
        if (name == null) {
            throw new ApiException("Missing the required parameter 'name' when calling getBlobStore1(Async)");
        }
        

        com.squareup.okhttp.Call call = getBlobStore1Call(name, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public AzureBlobStoreApiModel getBlobStore1(String name) throws ApiException {
        ApiResponse<AzureBlobStoreApiModel> resp = getBlobStore1WithHttpInfo(name);
        return resp.getData();
    }
     ...
     * 
     * @param name Name of the blob store configuration to fetch (required)
     * @return ApiResponse&lt;AzureBlobStoreApiModel&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<AzureBlobStoreApiModel> getBlobStore1WithHttpInfo(String name) throws ApiException {
        com.squareup.okhttp.Call call = getBlobStore1ValidateBeforeCall(name, null, null);
        Type localVarReturnType = new TypeToken<AzureBlobStoreApiModel>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Get an Azure blob store configuration by name (asynchronously)
     * 
     * @param name Name of the blob store configuration to fetch (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getBlobStore1Async(String name, final ApiCallback<AzureBlobStoreApiModel> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getBlobStore1ValidateBeforeCall(name, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<AzureBlobStoreApiModel>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    /**
     * Update an S3 blob store configuration by name (asynchronously)
     * 
     * @param name Name of the blob store to update (required)
     * @param body  (optional)
     * @param callback The callback to be executed when the API call finishes
    ...
    /**
     * Build call for updateBlobStore1
     * @param name Name of the blob store to update (required)
     * @param body  (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updateBlobStore1Call(String name, AzureBlobStoreApiModel body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateBlobStore1ValidateBeforeCall(String name, AzureBlobStoreApiModel body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'name' is set
        if (name == null) {
            throw new ApiException("Missing the required parameter 'name' when calling updateBlobStore1(Async)");
        }
        

        com.squareup.okhttp.Call call = updateBlobStore1Call(name, body, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void updateBlobStore1(String name, AzureBlobStoreApiModel body) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> updateBlobStore1WithHttpInfo(String name, AzureBlobStoreApiModel body) throws ApiException {
        com.squareup.okhttp.Call call = updateBlobStore1ValidateBeforeCall(name, body, null, null);
        return apiClient.execute(call);
    }

    /**
     * Update an Azure blob store configuration by name (asynchronously)
     * 
     * @param name Name of the blob store to update (required)
     * @param body  (optional)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateBlobStore1Async(String name, AzureBlobStoreApiModel body, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateBlobStore1ValidateBeforeCall(name, body, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
